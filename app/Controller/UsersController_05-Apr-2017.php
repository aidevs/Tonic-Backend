...
class UsersController extends AppController {
     ...
     * @var array
     */
    public $uses = array('User', 'Country', 'Appointment', 'Walkin', 'Week', 'Schedule', 'WalkinAppointment', 'WalkinAppointmentBarber', 'Advertisement','LunchBreak','Vacation');
    ...
    function beforeFilter() {
        ...
        $this->Auth->allow(array('admin_forgot', 'admin_reset_password', 'login', 'forgot_password', 'register', 'activate', 'reset_password'));
        parent::beforeFilter();
    ...
    public function admin_add() {
        ...
        if (!empty($this->request->data)) {
            ...
            if ($res = $this->User->save($this->request->data)) {
                $shop_url = Router::url(array('admin' => false, 'controller' => 'users', 'action' => 'login', 'slug' => $res['User']['shop_slug']), true);
...
//          $user = $this->User->findById($this->Auth->User('id'));
    ...
    public function waiting_list() {
        ...
        if (!empty($barberAdmin)) {
            ...
            $walkins = $this->WalkinAppointment->find('all', array('conditions' => array('WalkinAppointment.shop_id' => $barberAdmin['User']['id']), 'order' => array('WalkinAppointment.created' => 'asc')));
...
//                   pr($Advertisement); die;
	...
	public function barbervacation() {
        ...
        $conditions = array('Vacation.user_id' => $id,'Vacation.to_date >=' => date("Y-m-d 23:59:59"));
