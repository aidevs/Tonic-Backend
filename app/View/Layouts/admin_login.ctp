...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
            ...
            <?php echo $this->Form->create('User', array('url'=>array('controller'=>'users','action'=>'login'),"class" => "login-form",'style'=>(in_array($this->params['action'], array('admin_login')))?'display:block;':'display:none;')); ?>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
                                <?php echo $this->Form->input('email', array('class' => 'form-control placeholder-no-fix', 'label' => false, 'div' => false, 'placeholder' => 'Email', 'autocomplete'=>'off')); ?>
		...
		<div class="form-actions">
			<label class="checkbox">
                        <?php echo $this->Form->input('remmber_me', array('checked'=>true,'type' => 'checkbox', 'label' => false, 'div' => false,'class'=>'icheck')); ?>      
			Remember me </label>
	...
	<!-- BEGIN FORGOT PASSWORD FORM -->
        <?php  echo $this->Form->create('User', array('url'=>array('controller'=>'users','action'=>'forgot'),"class" => "forget-form",'style'=>(in_array($this->params['action'], array('admin_forgot','client_forgot')))?'display:block;':'display:none;')); ?>
	
		<h3>Forget Password ?</h3>
                 <?php 
                 if((in_array($this->params['action'], array('admin_forgot','client_forgot')))){
                    echo $this->Common->sessionFlash(); 
                 }?>
		<p>
...
<!-- BEGIN JAVASCRIPTS(Load javascripts at bottom, this will reduce page load time) -->
        ...
        <script src="<?php echo ASSETS_URL; ?>assets/admin/pages/scripts/login.js"></script>
        <script>
