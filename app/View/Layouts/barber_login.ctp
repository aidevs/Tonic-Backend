...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
            ...
            <?php echo $this->Form->create('User', array('url'=>array('controller'=>'barbers','action'=>'login'),"class" => "login-form",'style'=>(in_array($this->params['action'], array('barber_login')))?'display:block;':'display:none;')); ?>
		...
		<div class="form-group">
			...
			<label class="checkbox">
                        <?php echo $this->Form->input('remmber_me', array('checked'=>true,'type' => 'checkbox', 'label' => false, 'div' => false)); ?>      
			Remember me </label>
