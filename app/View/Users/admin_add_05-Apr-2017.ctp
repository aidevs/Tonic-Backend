				...
				<div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       ...
                                       <?php echo $this->Form->input('User.unlimited_barber',array('checked'=>false,'data-on-color'=>'success','data-off-color'=>'danger','class'=>'make-switch','data-on-text'=>'&nbsp;Unlimited&nbsp;&nbsp;&nbsp;&nbsp;','data-off-text'=>'&nbsp;Limited&nbsp;')); ?>
                                    </div>
                                </div>
