...
<div class="reslistBlock down" id="user_reserv_blk">
    ...
    <div class="headingBlock" style="font-size:5vh;">Upcoming reservations  <i class="fa fa-arrow-circle-up arrow_up_down" aria-hidden="true" id="arrow_up"></i><i class="fa fa-arrow-circle-down arrow_up_down" aria-hidden="true"  id="arrow_down" style="display:none;"></i>
