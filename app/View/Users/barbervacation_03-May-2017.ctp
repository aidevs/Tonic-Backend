						  ...
						  <div class="container selectdatecustom selectdatecustom2">	
							...
							<div id="vac_block<?php echo $vacation['Vacation']['id']; ?>" class="container selectdatecustom selectdatecustom2">
								...
								<div  class="col-xs-6 text-center">
									...
									<input disabled type="text" autocomplete="off" name="data[vacation][from_date]" class="timepicker datetimepicker text-center border3 inputcustomnew edittimepicker" value="<?php echo $vacation['Vacation']['from_date'];?>" placeholder="From Date" data-date-format="Y-m-d H:i" data-alt-input=true rel="<?php echo $vacation['Vacation']['id'] ?>" />
								</div>
								
								<div  class="col-xs-6 text-center">
									<label class="newcustomdate">Until</label>
									<input disabled type="text" name="data[vacation][to_date]" autocomplete="off" class="timepicker datetimepicker text-center border3 inputcustomnew edittimepicker" value="<?php echo $vacation['Vacation']['to_date'];?>" placeholder="Until" data-date-format="Y-m-d H:i" data-alt-input=true rel="<?php echo $vacation['Vacation']['id'] ?>" />
								</div>
							</div>
							<div class="container selectdatecustom selectdatecustom2">
...
<?php /* <link rel="stylesheet" href="<?php echo SITE_URL; ?>css/jquery-ui.css"> */ ?>

<!-- Google CDN jQuery with fallback to local -->
<script src="<?php echo SITE_URL; ?>js/jquery.mCustomScrollbar.concat.min.js"></script>
<?php /* <script src="http://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
<script src="<?php echo SITE_URL; ?>js/jquery-ui-timepicker-addon.js"></script> */ ?>

<link rel="stylesheet" href="<?php echo SITE_URL; ?>css/flatpickr.min.css">
<script src="<?php echo SITE_URL; ?>flatpickr/src/flatpickr.js"></script>
