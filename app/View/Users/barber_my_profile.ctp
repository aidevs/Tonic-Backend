...
<div class="reslistBlock down" id="barber_reserv_blk">
    	<div class="headingBlock">Upcoming reservations <i class="fa fa-arrow-circle-up arrow_up_down" aria-hidden="true" id="arrow_up"></i><i class="fa fa-arrow-circle-down arrow_up_down" aria-hidden="true"  id="arrow_down" style="display:none;"></i></div>
            ...
            foreach ($Appointment as $appointment) {
                ...
                <div class="item"> 
                    ...
                    <span class="textBlock">
                        ...
                        <a href="tel:<?php echo $appointment['User']['phone']; ?>"  >   <h6 class="phonenumber"><?php echo $appointment['User']['phone']; ?></h6>	</a>				<?php 
                        $service=array();
                        if(!empty($appointment['AppointmentService'])){
                            foreach ($appointment['AppointmentService'] as $value) { 
                                array_push($service, $value['Service']['name']);  
                            } 
                        }
                        ?> 
                        <br>
                        <h6 class="pull-left"><?php echo implode(', ', $service); ?></h6>    
