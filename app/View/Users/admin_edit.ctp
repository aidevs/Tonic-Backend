				...
				<div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       ...
                                       <?php echo $this->Form->input('User.unlimited_barber',array('data-on-color'=>'success', 'type'=>'checkbox','data-off-color'=>'danger','class'=>'make-switch','data-on-text'=>'&nbsp;Full Shop&nbsp;&nbsp;&nbsp;&nbsp;','data-off-text'=>'&nbsp;Solo&nbsp;')); ?>
                                    </div>
                                </div>
				<div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       ...
                                       <?php echo $this->Form->input('User.is_ad_on',array('data-on-color'=>'success','data-off-color'=>'danger','class'=>'make-switch','data-on-text'=>'&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;','data-off-text'=>'&nbsp;No&nbsp;')); ?>
                                    </div>
                                </div>				
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       ...
                                       <?php echo $this->Form->input('User.is_social_on',array('data-on-color'=>'success','data-off-color'=>'danger','class'=>'make-switch','data-on-text'=>'&nbsp;Enable&nbsp;&nbsp;&nbsp;&nbsp;','data-off-text'=>'&nbsp;Disable&nbsp;')); ?>
                                    </div>
                                </div>
                                <div class="form-group">
