    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">                            
                ...
                <li>
                    <a href="javascript:void(0);">Add New Service</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-text">
                                            ...
                                            echo $this->Form->input('time', array('options'=>$opt,'class' => 'form-control')); ?>
                                        </div>
                                    </div>
                                </div>                         
				...
				<div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       ...
                                       <?php echo $this->Form->input('status',array('checked'=>true,'data-on-color'=>'success','data-off-color'=>'danger','class'=>'make-switch','data-on-text'=>'&nbsp;Enabled&nbsp;&nbsp;','data-off-text'=>'&nbsp;Disabled&nbsp;')); ?>
                                    </div>
                                </div>
                                <div class="form-group">
