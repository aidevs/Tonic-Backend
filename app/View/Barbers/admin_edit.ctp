    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">                            
                ...
                <li>
                    <a href="javascript:void(0);">Edit Barber</a>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue" id="form_wizard_1">
                    ...
                    <div class="portlet-body form">
                        <?php
                        echo $this->Form->create('User', array('type' => 'file', 'class' => 'form-horizontal user-form', 'inputDefaults' => array('label' => false, 'div' => false, 'hiddenField' => false), 'novalidate' => 'novalidate'));
                        echo $this->Form->hidden('User.id');
                        echo $this->Form->hidden('User.old_image', array('value' => $this->request->data['User']['image']));
                        ?>               
                        <div class="form-wizard">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-text">
                                            <?php echo $this->Form->input('User.pin', array(
												'options'=>$pin ,
												'class' => 'form-control',
												'disabled' => $assigned_pins
											)); ?>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="<?php echo $this->Common->getUserImage($this->request->data['User']['image'], 200, 150, 1, 'admin'); ?>" />
                                            </div>
...
echo <<<HTML
	$(document).ready(function(){
		var ary=$assigned_pins;
		$('#UserPin option').filter(function(){
