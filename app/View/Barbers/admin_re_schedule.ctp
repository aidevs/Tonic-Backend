                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-3 col-md-8"> 
                                        ...
                                        <a href="<?php echo Router::url(array('admin' => true, 'controller' => 'barbers', 'action' => 'schedule',$this->params['pass'][0])); ?>" class="btn default button-previous"><i class="fa fa-close"></i> Cancel </a>
                                    </div>
                                </div>
                            </div>
                        </div>
