            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue" id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-tree"></i> Add
                        </div>                
                    </div>
                    <div class="portlet-body form">
                        <?php echo $this->Form->create('Vacation', array('class' => 'form-horizontal vacation-form', 'inputDefaults' => array('label' => false, 'div' => false, 'hiddenField' => false),'novalidate'=>'novalidate')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-text">
                                            <?php echo $this->Form->input('from_date', array('class' => 'form-control vacation-date-from', 'type'=>'text')); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-text">
                                            <?php echo $this->Form->input('to_date', array('class' => 'form-control vacation-date-to', 'type'=>'text')); ?>
                                        </div>
                                    </div>
