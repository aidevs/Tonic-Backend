<script>    
            ...
            var aTargets=[2];
            var tOrder=[1, "asc"];
            var ajaxUrl=path+prefix+"/customers/pending_walkin_list";
</script>
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="javascript:void(0);">Pending Walk-In</a>
                </li>
            </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-male"></i>Pending Walk-In Listing
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td> <?php echo $this->Form->input('created',array('label'=>false,'div'=>false,'type'=>'text','class'=>'form-control form-filter input-sm createdate')); ?>   </td>
                                        <td>
...
<div aria-hidden="true" role="basic" id="seat-ajax" class="modal fade" style="display: none;">    
    <div class="modal-dialog">
        <div class="modal-content">
